...
public class Text사과 : MonoBehaviour
{
    ...
    {
        yield return StartCoroutine(NormalChat("제갈명식", "저도 앞을 잘 못 본거같네요", false));
        yield return StartCoroutine(NormalChat("제갈명식", "죄송합니다", false));
        yield return StartCoroutine(NormalChat("곽두팔", "아, 네 뭐", false));
        yield return StartCoroutine(NormalChat("제갈명식", "이거라도 받으세요", false));
        yield return StartCoroutine(NormalChat("시스템", "사과를 받았다", true));
