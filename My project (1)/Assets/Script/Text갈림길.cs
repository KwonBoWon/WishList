...
public class Text갈림길 : MonoBehaviour
{
    ...
    {
        yield return StartCoroutine(NormalChat("곽두팔", "제일 시간 가까운표 하나 주세요", false));
        yield return StartCoroutine(NormalChat("역무원", "버스로표로요? 기차표로요?", false));
        yield return StartCoroutine(NormalChat("곽두팔", "어...", true));
