...
public class Text사과나무 : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("곽두팔", "맞다 병원에서 만난분 한테 받은 사과", false));

        yield return StartCoroutine(NormalChat("곽두팔", "여기 딱 심기좋은 땅이 있네", false));

        yield return StartCoroutine(NormalChat("곽두팔", "이 나무가 자라서 열매를 맺으려면 몇년이 걸릴까..?", true));
    }
