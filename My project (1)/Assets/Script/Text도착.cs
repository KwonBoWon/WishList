...
public class Text도착 : MonoBehaviour
{
    ...
    {
        yield return StartCoroutine(NormalChat("곽두팔", "드디어 도착했다.", false));
        yield return StartCoroutine(NormalChat("곽두팔", "낯선 글자...", false));
        yield return StartCoroutine(NormalChat("곽두팔", "여긴 대체 어딜까?", true));
