...
public class Text스키보드 : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("곽두팔", "갈림길?", false));
        yield return StartCoroutine(NormalChat("곽두팔", "오른쪽은 쉬워보이고", false));
        yield return StartCoroutine(NormalChat("곽두팔", "왼쪽은 가면 죽을거같이 생겼네", true));
