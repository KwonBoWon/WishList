...
public class Text가방 : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("곽두팔", "저건 내가방이잖아", false));
        yield return StartCoroutine(NormalChat("곽두팔", "의자위에 가방을 뒀더니 저사람이 헷갈린거같은데?", false));
        yield return StartCoroutine(NormalChat("곽두팔", "찾으러 갈까?", false));
        yield return StartCoroutine(NormalChat("곽두팔", "귀찮은데 그냥 이 가방 들고갈까?", true));
