...
public class Text스키장 : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("곽두팔", "이런곳에 스키장이 있네", false));

        yield return StartCoroutine(NormalChat("곽두팔", "좋아 바로 타러가자!", true));
