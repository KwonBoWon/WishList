...
public class Text뭐하지 : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("곽두팔", "이제 뭐부터 해야 하지", false));
        yield return StartCoroutine(NormalChat("곽두팔", "떠나기전에 집에 들릴까?", false));
        yield return StartCoroutine(NormalChat("곽두팔", "시간이 아까운데 바로 출발할까?", true));
