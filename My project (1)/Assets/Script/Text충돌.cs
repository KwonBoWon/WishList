...
public class Text충돌 : MonoBehaviour
{
    ...
    {
        yield return StartCoroutine(NormalChat("제갈명식", "악, 저기요", false));
        yield return StartCoroutine(NormalChat("곽두팔", "아, 뭐야", false));
        yield return StartCoroutine(NormalChat("제갈명식", "병원에서 왜 뛰어다니세요", false));
        yield return StartCoroutine(NormalChat("곽두팔", "나 지금 급해!", true));
