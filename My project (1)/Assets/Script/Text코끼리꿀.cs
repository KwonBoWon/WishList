...
public class Text코끼리꿀 : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("곽두팔", "뭘 원하는건가?", false));
        yield return StartCoroutine(NormalChat("곽두팔", "꿀 먹을래?", false));
        yield return StartCoroutine(NormalChat("코끼리", "뿌우~", false));
        yield return StartCoroutine(NormalChat("곽두팔", "생각보다 착하잖아?", true));
    }
