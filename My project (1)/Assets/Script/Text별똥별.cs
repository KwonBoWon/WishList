...
public class Text별똥별 : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("곽두팔", "하늘에 별똥별들이...", false));
        yield return StartCoroutine(NormalChat("곽두팔", "너무 예쁘다...", false));
        yield return StartCoroutine(NormalChat("곽두팔", "소원 빌어야 겠지?", false));


        yield return StartCoroutine(NormalChat("곽두팔", "지구멸망하게 해주세요...", true));
