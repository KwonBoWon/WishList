...
public class Text스쿠버다이빙 : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("곽두팔", "내 운동신경덕에 안전하게 착지했다", false));
        yield return StartCoroutine(NormalChat("곽두팔", "바다에 떨어진김에 바로 스쿠버다이빙이다!", false));
        yield return StartCoroutine(NormalChat("곽두팔", "이대로 육지까지 가자!", true));
