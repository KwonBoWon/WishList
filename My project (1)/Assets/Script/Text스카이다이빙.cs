...
public class Text스카이다이빙 : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("곽두팔", "으아악", false));
        yield return StartCoroutine(NormalChat("곽두팔", "내가 스카이다이빙을 해보다니", false));
        yield return StartCoroutine(NormalChat("곽두팔", "낙하산 잘 펴지겠지?", true));
